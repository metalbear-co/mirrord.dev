---
title: "Guide: Traffic Stealing"
linktitle: "Traffic Stealing"
...
Both your local process and your remote pod will need to receive traffic.
...
To specify a filter on a path, use the `feature.network.incoming.http_filter.header_filter` configuration:
